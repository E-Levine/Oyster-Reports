...
#Change Rescale*n to correct flow pattern as needed
ggarrange(
  #LNX
  ggplot() +
    geom_area(data = LRE_Flow_2 %>% filter(Site == "LXN"), aes(Date, Rescale*1.64), fill = rgb(156, 156, 156, maxColorValue = 255))+
  ...
  #LXS
  ggplot() +
    geom_area(data = LRE_Flow_2 %>% filter(Site == "LXS"), aes(Date, Rescale*1.25), fill = rgb(156, 156, 156, maxColorValue = 255))+
    ...
    scale_x_date("", expand= c(0,0), date_breaks = "1 month", date_labels = "%b", limits = c(Start_date %m-% days(5), End_date %m-% days(5)))+
    scale_y_continuous("Salinity", expand = c(0,0), sec.axis = sec_axis(~.*(480/40), name = "Flow (cfs)", breaks = seq(0,480, 120))) +
    coord_cartesian(ylim = c(0, 40))+
