...
output: 
  word_document: 
    ...
    fig_caption: yes
params:
  Start_date: "2025-07-01" #Start date of reporting quarter
  End_date: "2025-09-30"   #End date of reporting quarter
---
...
Cage_df <- readWorkbook("../Data/CERP_PBC_Summary_Data.xlsx", sheet = 'SH Mort Site', detectDates = TRUE, check.names = TRUE)
#Water Quality
