...
<p> Salinity range: `r WQ_Sal_CRE %>% dplyr::select(contains("Sal")) %>% unlist() %>% min()` - `r WQ_Sal_CRE %>% dplyr::select(contains("Sal")) %>% unlist() %>% max()`\
`r CRE_Sec %>% tab_caption(caption = "Monthly CRE secchi measurements")`
<p> Secchi range: `r WQ_Sec_CRE %>% dplyr::select(contains("SP")) %>% unlist() %>% min()` - `r WQ_Sec_CRE %>% dplyr::select(contains("SP")) %>% unlist() %>% max()`\
...
<p> Salinity range: `r WQ_Sal_PBC %>% dplyr::select(contains("Sal")) %>% unlist() %>% min()` - `r WQ_Sal_PBC %>% dplyr::select(contains("Sal")) %>% unlist() %>% max()`\
`r PBC_Sec %>% tab_caption(caption = "Monthly PBC secchi measurements")`
<p> Secchi range: `r WQ_Sec_PBC %>% dplyr::select(contains("SP")) %>% unlist() %>% min()` - `r WQ_Sec_PBC %>% dplyr::select(contains("SP")) %>% unlist() %>% max()`\
