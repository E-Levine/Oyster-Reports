...
<p> Recruitment range: `r Rcrt_CERP %>% dplyr::select(contains("Mean")) %>% unlist() %>% min(na.rm = T)` - `r Rcrt_CERP %>% dplyr::select(contains("Mean")) %>% unlist() %>% max(na.rm = T)` </p>
...
<p> Salinity range: `r WQ_Sal_CERP %>% dplyr::select(contains("Sal")) %>% unlist() %>% min()` - `r WQ_Sal_CERP %>% dplyr::select(contains("Sal")) %>% unlist() %>% max()`\
...
<p> Recruitment range: `r Rcrt_CRE %>% dplyr::select(contains("Mean")) %>% unlist() %>% min(na.rm = T)` - `r Rcrt_CRE %>% dplyr::select(contains("Mean")) %>% unlist() %>% max(na.rm = T)` </p>
...
<p> Salinity range: `r WQ_Sal_CRE %>% dplyr::select(contains("Sal")) %>% unlist() %>% min(na.rm = T)` - `r WQ_Sal_CRE %>% dplyr::select(contains("Sal")) %>% unlist() %>% max(na.rm = T)`\
`r CRE_Sec %>% tab_caption(caption = "Monthly CRE secchi measurements")`
<p> Secchi range: `r WQ_Sec_CRE %>% dplyr::select(contains("SP")) %>% unlist() %>% min(na.rm = T)` - `r WQ_Sec_CRE %>% dplyr::select(contains("SP")) %>% unlist() %>% max(na.rm = T)`\
...
<p> Recruitment range: `r Rcrt_PBC %>% dplyr::select(contains("Mean")) %>% unlist() %>% min(na.rm = T)` - `r Rcrt_PBC %>% dplyr::select(contains("Mean")) %>% unlist() %>% max(na.rm = T)` </p>
Summary by reef type:
...
<p> Salinity range: `r WQ_Sal_PBC %>% dplyr::select(contains("Sal")) %>% unlist() %>% min(na.rm = T)` - `r WQ_Sal_PBC %>% dplyr::select(contains("Sal")) %>% unlist() %>% max(na.rm = T)`\
