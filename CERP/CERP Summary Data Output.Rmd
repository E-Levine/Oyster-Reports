...
DeadRatio_sta_new <- Station_summ_S %>% distinct() %>% filter(!`CR-E1_LiveMean` %in% unique(DeadRatio_Station$`CR-E1_LiveMean`))
#
...
DeadRatio_sit_new <- Site_summ_S %>% distinct() %>% filter(!`CR-E_LiveMean` %in% unique(DeadRatio_Site$`CR-E_LiveMean`))
#
...
SH_sta_new <- Station_summ_SH %>% distinct() %>% filter(!`CR-E1_SHMean` %in% unique(SH_Station$`CR-E1_SHMean`))
#
...
SH_sit_new <- Site_summ_SH %>% distinct() %>% filter(!`CR-E_SHMean` %in% unique(SH_Site$`CR-E_SHMean`))
