...
Srvy_counts_new <- Srvy_counts_raw_data %>% distinct() %>% arrange(Year, Month, Site, Station) %>% filter(!RetDate %in% unique(Srvy_counts_raw$RetDate))
#
...
Srvy_SH_new <- Srvy_SH_raw_data %>% distinct() %>% arrange(Year, Month, Site, Station) %>% filter(!RetDate %in% unique(Srvy_SH_raw$RetDate))
