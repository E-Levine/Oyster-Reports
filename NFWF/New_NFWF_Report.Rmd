...
ggarrange(recruit_plot_list[4] + rremove('x.text') + theme(plot.margin = unit(c(0,0.2,-0.5,0.1), "lines")),
          recruit_plot_list[5] + rremove('x.text')+ theme(plot.margin = unit(c(-0.5,0.2,-0.5,0.1), "lines")),
          recruit_plot_list[6] + theme(plot.margin = unit(c(-0.5,0.2,0,0.1), "lines")),
          nrow = 3, ncol = 1)
