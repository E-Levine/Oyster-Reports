...
#
Sdtp2 <- Sedi1 %>% filter(AnalysisDate > ReportStart & AnalysisDate < ReportEnd) %>% mutate(ID = paste0(Estuary, SectionName, "-", StationNumber), Cup = str_sub(CupSampleID, -1)) %>% dplyr::select(ID, Cup, TotalDW, TotalAsh, Comments) 
