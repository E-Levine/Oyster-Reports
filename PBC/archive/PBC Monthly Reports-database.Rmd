...
Database <- "Oysters_25-08-29"  #Set the local database to use
...
#
Sdtp2 <- Sedi1 %>% filter(AnalysisDate > ReportStart) %>% mutate(ID = paste0(Estuary, SectionName, "-", StationNumber), Cup = str_sub(CupSampleID, -1)) %>% dplyr::select(ID, Cup, FilterDryWeight, TotalDW, TotalAsh) 
#
