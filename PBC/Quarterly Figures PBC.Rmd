...
#Water Quality
WQ_Sal_s <-  readWorkbook("../CERP/WQ_Summary_Data.xlsx", sheet = 'Salinity Station', detectDates = TRUE, check.names = TRUE)
WQ_Tem_s <-  readWorkbook("../CERP/WQ_Summary_Data.xlsx", sheet = 'Temp Station', detectDates = TRUE, check.names = TRUE)
WQ_pH_s <-  readWorkbook("../CERP/WQ_Summary_Data.xlsx", sheet = 'pH Station', detectDates = TRUE, check.names = TRUE)
WQ_DO_s <-  readWorkbook("../CERP/WQ_Summary_Data.xlsx", sheet = 'DO Station', detectDates = TRUE, check.names = TRUE)
WQ_Secchi_s <-  readWorkbook("../CERP/WQ_Summary_Data.xlsx", sheet = 'Secchi Station', detectDates = TRUE, check.names = TRUE)
