...
QuadStats_LegalONLY_Oys_Recent <- QuadStats_LegalONLY_1 %>%
...
# Legal ONLY
  write.xlsx(list(
    "LegalONLY_Recent" = QuadStats_LegalONLY_Oys_Recent), 
    file = LegalONLY, colNames = TRUE)
  # Open the workbook for further customization
  wb <- loadWorkbook(LegalONLY)
  # Auto-adjust column widths
  setColWidths(wb, sheet = "LegalONLY_Recent", cols = 1:ncol(QuadStats_LegalONLY_Oys_Recent), widths = "auto")

  # Freeze the first row
  freezePane(wb, sheet = "LegalONLY_Recent", firstRow = TRUE)
