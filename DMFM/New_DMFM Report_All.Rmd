...
Database = "OysterLocalMD20241114"  # Set the local database to use
...
# Stats for Total Oyster Density and Total Weight Density by Year and StationGroup
# Oysters
QuadStats_ALL_Oys1_fig <- generate_grouped_plot(QuadStats_ALL_Oys1, "Year", "Year", "OysterDensityMean", "Live oysters / m2)", "OysterDensitySD", "StationGroup", "StationGroup", "AB Oyster Density by Year and StationGroup")
print(QuadStats_ALL_Oys1_fig)

# Creating figures Mean Sample Weight Density
QuadStats_ALL_Oys1_Sample_Weight_fig <- generate_grouped_plot(QuadStats_ALL_Oys1, "Year", "Year", "WeightDensityMean", "Sample Weight (kg / m2)", "WeightDensitySD", "StationGroup", "StationGroup", "AB Sample Weight Density by Year and StationGroup")
...
# Stats for Total Oyster Density and Total Weight Density by Year and Section and StationGroup
QuadStats_ALL_Oys2_fig <- generate_grouped_plot(QuadStats_ALL_Oys2, "Year", "Year", "OysterDensityMean", "Live oysters / m2)", "OysterDensitySD",  "StationGroup", "StationGroup", "AB Oyster Density by Year and Section and StationGroup")
print(QuadStats_ALL_Oys2_fig)

# Creating figures Mean Sample Weight Density
QuadStats_ALL_Oys2_Sample_Weight_fig <- generate_grouped_plot(QuadStats_ALL_Oys2, "Year", "Year", "WeightDensityMean", "Sample Weight (kg / m2)", "WeightDensitySD", "AB Sample Weight Density by Year and Section and StationGroup")
