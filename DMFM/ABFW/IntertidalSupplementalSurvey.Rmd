...
`r kable(DensitiesALL, caption = "Densities of all sampled areas combined.")`

`r kable(DensitiesCounty, caption = "Densities of all sampled areas divided by county line at longitude -85.221667.")`

`r kable(DensitiesSHA, caption = "Densities of all sampled areas divided by FDACS Shellfish Harvest Areas (SHA). <br>Points west of longitude -85.23500 correspond to 1552, Conditionally Approved, Indian Lagoon Winter B. <br>Points between longitude -85.23500 and -85.221667 correspond to 1542, Conditionally Approved, Indian Lagoon Winter A. <br>Points east of longitude -85.221667 correspond to 1611, Approved, Apalachicola Bay Winter A.")`

`r kable(DensitiesSubset, caption = "Densities of all sampled areas divided by SHA subsets. <br>Indian Lagoon West (ILW) corresponds to SHA 1552 as defined above. <br>Indian Lagoon Central (ILC) corresponds to SHA 1542 as defined above. <br>Indian Lagoon East (ILE) corresponds to points between longitude -85.221667 and -85.20000. <br>St. Vincent Sound (SVS)  correspond to points east of longitude -85.20000.")`

`r kable(DensitiesStation, caption = "Densities of all sampled stations listed indivdually and sorted from highest density to lowest density.")`